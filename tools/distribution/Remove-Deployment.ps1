...
contains no deletion or purge implementation. The caller must provide a sealed ownership manifest,
the retained ownership state, and a fresh exact-ID readback captured by a separately approved
workflow. The contract engine rejects missing, stale, duplicate, ambiguous, contradictory, or
protected evidence before it emits either a dry-run preview or a phase-specific authorization.
