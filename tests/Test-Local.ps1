...
try {
    ...
    '.\tests\control\entitlement-binding-add.test.mjs'      = 'The entitlement binding creation tests failed.'
        ...
        '.\tests\control\identifier-assistance.test.mjs'         = 'The authorized identifier assistance tests failed.'
        ...
        '.\tests\deployment\ownership-evidence-generation.test.mjs' = 'The offline ownership evidence generation pipeline failed.'
